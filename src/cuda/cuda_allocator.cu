...
//
// 	if (ptr_attr.type == cudaMemoryTypeDevice && ptr_attr.devicePointer !=
// NULL) { 		return SPMM_INTERNAL_STATUS_ALREADY_INITIALIZED;
// 	}
//
...
// }
//
// SpmmInternalStatus_t mem_arena_dev_push(DevArena* const arena, const u64
// bsize, void** ptr_out)
// {
// 	if (!arena) {
// 		return SPMM_INTERNAL_STATUS_MEMOP_FAIL;
// 	}
//
// 	const u64 pos_aligned = arena->pos + PADDING_POW2(arena->pos,
// sizeof(void*)); 	const u64 new_pos = pos_aligned + bsize;
//
